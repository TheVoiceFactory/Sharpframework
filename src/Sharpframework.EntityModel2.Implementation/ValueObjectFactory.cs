...
namespace Sharpframework.EntityModel.Implementation
{
    ...
    public abstract class ValueObjectFactory<InterfaceType, FactoryType>
        : ValueObjectFactory<
                InterfaceType,
                ValueObjectFactory<InterfaceType, FactoryType>.DummyInitDto,
                FactoryType>
        , IFactory<InterfaceType>
        //, ISerializable<IValueUnit, InterfaceType>
    where InterfaceType : IValueObject
    where FactoryType   : ValueObjectFactory<InterfaceType, FactoryType>
                        , new()
    {
    ...
    public abstract class ValueObjectFactory<InterfaceType, InitDtoType, FactoryType>
        ...
        , ISerializable<IValueUnit, InterfaceType>
    where InterfaceType : IValueObject
    where InitDtoType   : ValueObjectFactory<InterfaceType, InitDtoType, FactoryType>.AbsValueObjectInitDto
                        , new ()
    where FactoryType   : ValueObjectFactory<InterfaceType, InitDtoType, FactoryType>
                        , new ()
    {
